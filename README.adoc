...
`/src/main/java/io/inuit/DockerDemoApplication.java`
...
* The image name (or tag), which will end up here as `springio/docker-demo`
...
81c723d22865        springio/docker-demo:latest   "java -jar /app.jar"   34 seconds ago      Up 33 seconds       0.0.0.0:8080->8080/tcp   goofy_brown         
----
...
----
$ docker run -e "SPRING_PROFILES_ACTIVE=prod" -p 8080:8080 -t springio/docker-demo
----

or

----
$ docker run -e "SPRING_PROFILES_ACTIVE=dev" -p 8080:8080 -t springio/docker-demo
----
...
----
$ docker run -e "JAVA_OPTS=-agentlib:jdwp=transport=dt_socket,address=5005,server=y,suspend=n" -p 8080:8080 -p 5005:5005 -t springio/docker-demo
----
